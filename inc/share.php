...
function makotokw_share_buttons() {
	...
	<ul class="share-buttons">
		<li class="share-twitter">
			<a rel="nofollow noopener" data-url="<?php echo esc_url( $permalink ); ?>" class="btn-share btn-share-twitter" href="https://x.com/intent/post?text=<?php echo rawurlencode( $title ); ?>&url=<?php echo rawurlencode( $permalink ); ?>&via=<?php echo rawurlencode( WP_THEME_AUTHOR_TWITTER ); ?>" target="_blank" data-tippy-content="<?php esc_attr_e( 'Share by X', 'makotokw' ); ?>">
				<i class="fab fa-x-twitter"></i>
				<span class="share-title"><?php esc_html_e( 'X', 'makotokw' ); ?></span>
			</a>
		</li>
		<li class="share-facebook">
			<a rel="nofollow noopener" class="btn-share btn-share-facebook" href="//www.facebook.com/sharer.php?u=<?php echo rawurlencode( $permalink ); ?>&t=<?php echo rawurlencode( $title ); ?>" target="_blank" data-tippy-content="<?php esc_attr_e( 'Share by Facebook', 'makotokw' ); ?>">
				...
				<span class="share-title"><?php esc_html_e( 'Facebook', 'makotokw' ); ?></span>
			</a>
		</li>
		<li class="share-hatena">
			<a rel="nofollow noopener" class="btn-share btn-share-hatena" href="<?php echo esc_url( 'https://b.hatena.ne.jp/entry/' . $permalink_schemeless ); ?>" target="_blank" data-tippy-content="<?php esc_attr_e( 'Share by Hatena', 'makotokw' ); ?>">
				...
				<span class="share-title"><?php esc_html_e( 'Hatena Bookmark', 'makotokw' ); ?></span>
			</a>
		</li>
		<li class="share-line">
...
C253.185,138.381 230.249,138.381 230.249,138.381 C230.249,138.381 230.249,153.146 230.249,153.146 C230.249,153.146 253.185,153.146 253.185,153.146 C257.710,153.146 261.408,156.851 261.408,161.398 C261.408,165.960 257.710,169.660 253.185,169.660 C253.185,169.660 222.018,169.660 222.018,169.660 C217.491,169.660 213.795,165.960 213.795,161.398 C213.795,161.398 213.795,130.149 213.795,130.149 C213.795,130.139 213.795,130.139 213.795,130.129 C213.795,130.129 213.795,130.114 213.795,130.109 C213.795,130.109 213.795,98.878 213.795,98.878 C213.795,98.858 213.795,98.850 213.795,98.841 C213.795,94.296 217.486,90.583 222.018,90.583 C222.018,90.583 253.185,90.583 253.185,90.583 C257.722,90.583 261.408,94.296 261.408,98.841 C261.408,103.398 257.722,107.103 253.185,107.103 C253.185,107.103 230.249,107.103 230.249,107.103 C230.249,107.103 230.249,121.872 230.249,121.872 C230.249,121.872 253.185,121.872 253.185,121.872 ZM202.759,161.398 C202.759,164.966 200.503,168.114 197.135,169.236 C196.291,169.521 195.405,169.660 194.526,169.660 C191.956,169.660 189.502,168.431 187.956,166.354 C187.956,166.354 156.012,122.705 156.012,122.705 C156.012,122.705 156.012,161.398 156.012,161.398 C156.012,165.960 152.329,169.660 147.791,169.660 C143.256,169.660 139.565,165.960 139.565,161.398 C139.565,161.398 139.565,98.841 139.565,98.841 C139.565,95.287 141.829,92.142 145.192,91.010 C146.036,90.730 146.915,90.583 147.799,90.583 C150.364,90.583 152.828,91.818 154.366,93.894 C154.366,93.894 186.310,137.559 186.310,137.559 C186.310,137.559 186.310,98.841 186.310,98.841 C186.310,94.296 190.000,90.583 194.536,90.583 C199.073,90.583 202.759,94.296 202.759,98.841 C202.759,98.841 202.759,161.398 202.759,161.398 ZM127.737,161.398 C127.737,165.960 124.051,169.660 119.519,169.660 C114.986,169.660 111.300,165.960 111.300,161.398 C111.300,161.398 111.300,98.841 111.300,98.841 C111.300,94.296 114.986,90.583 119.519,90.583 C124.051,90.583 127.737,94.296 127.737,98.841 C127.737,98.841 127.737,161.398 127.737,161.398 ZM95.507,169.660 C95.507,169.660 64.343,169.660 64.343,169.660 C59.816,169.660 56.127,165.960 56.127,161.398 C56.127,161.398 56.127,98.841 56.127,98.841 C56.127,94.296 59.816,90.583 64.343,90.583 C68.881,90.583 72.564,94.296 72.564,98.841 C72.564,98.841 72.564,153.146 72.564,153.146 C72.564,153.146 95.507,153.146 95.507,153.146 C100.047,153.146 103.728,156.851 103.728,161.398 C103.728,165.960 100.047,169.660 95.507,169.660 Z"/>
				...
				<span class="share-title"><?php esc_html_e( 'Line', 'makotokw' ); ?></span>
			</a>
		</li>
		<li class="share-pocket">
			<a rel="nofollow noopener" class="btn-share btn-share-pocket" href="https://getpocket.com/save/?url=<?php echo rawurlencode( $permalink ); ?>&title=<?php echo rawurlencode( $title ); ?>" target="_blank" data-tippy-content="<?php esc_attr_e( 'Share by Pocket', 'makotokw' ); ?>">
				...
				<span class="share-title"><?php esc_html_e( 'Pocket', 'makotokw' ); ?></span>
			</a>
		</li>
		<li class="share-url">
			<button class="btn-share btn-share-url" data-clipboard-text="<?php echo esc_url( $permalink ); ?>" data-toast-success="<?php esc_attr_e( 'URL Copied!', 'makotokw' ); ?>" data-toast-error="<?php esc_attr_e( 'Failed to copy URL.', 'makotokw' ); ?>" data-tippy-content="<?php esc_attr_e( 'Copy URL', 'makotokw' ); ?>">
				<i class="fas fa-copy"></i>
				<span class="share-title"><?php esc_html_e( 'Copy URL', 'makotokw' ); ?></span>
			</button>
		</li>
	</ul>
	<?php
...
function makotokw_share_this() {
	?>
	<div id="shareThis" class="share-this section-inner" data-url="<?php echo esc_url( makotokw_get_share_permalink() ); ?>">
